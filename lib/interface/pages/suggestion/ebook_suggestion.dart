...
class EbookSuggestion extends StatefulWidget {
  @override
  _EbookSuggestionState createState() => _EbookSuggestionState();
}

class _EbookSuggestionState extends State<EbookSuggestion> {

  EbookSuggestBloc suggestBloc;
  String suggest1 =  ApiConstant.SUGGEST1;
